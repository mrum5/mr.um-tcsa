...
echo "
                      ...
                      \__   __/(  ____ \(  ____ \(  ___  )
                         ...
                         | |   | |            ) || (   ) |
                         | |   | (____/\/\____) || )   ( |
                         )_(   (_______/\_______)|/     \|  v 1.0" |lolcat
...
echo " "
echo "[*]Installing tcsa please wait " |lolcat
sleep 3
...
tput cup 15 0
echo -en "\e[93m Do you join our group? (y/n)? \e[m "
read answer
...
tput cup 17 23
    echo -e "\x1b[41m Please join our group Annihilation Mobile group(BD Game Lover) \x1b[m"
fi
tput cup 20 0
figlet -f slant "Mr.UM" |lolcat
echo " "
echo " "
#done setting up
